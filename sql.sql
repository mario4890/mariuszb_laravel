...
-- Zrzut struktury bazy danych mariuszb_laravel
CREATE DATABASE IF NOT EXISTS `mariuszb_laravel` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mariuszb_laravel`;
...
-- Zrzucanie danych dla tabeli mariuszb_laravel.migrations: ~3 rows (około)
...
-- Zrzucanie danych dla tabeli mariuszb_laravel.sites: ~4 rows (około)
...
-- Zrzucanie danych dla tabeli mariuszb_laravel.users: ~1 rows (około)
